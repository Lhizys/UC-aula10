...
try:
    #plt.boxplot(array_recup_veiculo)
    #plt.boxplot(array_recup_veiculo, vert=False, showmeans=True)

    plt.subplots(2, 2, figsize=(16, 7))
    plt.suptitle('Recuperação de veículo', fontsize=20)

    plt.subplot(2, 2, 1)
    plt.boxplot(array_recup_veiculo, vert=False, showmeans=True)
    plt.title("Recuperação de veículo")

    plt.subplot(2, 2, 2)
    plt.hist(array_recup_veiculo, bins=50, edgecolor='black')
    plt.axline(media, color='g', linewidth=1)
    plt.axline(mediana, color='y', linewidth=1)
    ...
    plt.suptitle('Analise de recuperação de veiculos no RJ')
    plt.subplot(1, 2, 1)
    plt.boxplot(array_recup_veiculo, vert=False, showmeans=True)
    ...
    print(f'Erro ao vizualizar os dados')
    exit()
